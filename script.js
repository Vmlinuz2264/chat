...
fetch("https://clouddata.scratch.mit.edu/logs?projectid=" + document.getElementById("server").value + "&limit=40&offset=0").then(function (r){return r.json()}).then(function (j){
